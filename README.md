...
The over-all aim of this project was to introduce myself to some applications of Data Engineering and creating data pipelines within cloud computing resources.
